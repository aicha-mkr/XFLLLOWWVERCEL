...
import { Search, Plus, ShoppingCart, Printer, Trash2, MoreHorizontal } from "lucide-react";
                  ...
                  <TableCell colSpan={6} className="text-center py-8">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <p className="text-muted-foreground">
                        {searchTerm ? "Aucun bon de commande trouvé" : "Aucun bon de commande d'achat enregistré"}
                      </p>
                      {!searchTerm && (
